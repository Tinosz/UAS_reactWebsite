...
import apiData from './API_data/apiData_Thriller.json'; // Assuming the downloaded file is named 'apiData.json'
...
function Thriller() {
  ...
  const renderSlides = () => {
    return works.map((work, index) => {
      ...
      return (
        <div key={work.key} className="gen-slide" id='thriller-slide'>
      ...
      <div className="gen-slider-vase">
        <div className="gen-upper-section">
          <div className="gen-topic-box">
            <h2 className="gen-case C">Thriller</h2>
          </div>
